   ...
   //     System.out.println(output);
      ...
      for(int repeat = 0; repeat <10; repeat ++)
      {
         ...
         //* first prep preposition
            /*NPPhraseSpec NOW */ place = nlgFactory.createNounPhrase(ranNoun(new String[]{"3."}));// prepositional phrase
            place.setDeterminer(ranDet());
            pp = nlgFactory.createPrepositionPhrase();
            pp.addComplement(place);
       ...
       //  if(Math.random()>.5)
         ...
         /*String Now*/ output = realiser.realiseSentence(p);
         System.out.println(output);
      }
      ...
      for(int i = 0; i<1; i++)
      {
        ...
        // ind.addComplement(dep);
         String output1 = realiser.realiseSentence(ind);
